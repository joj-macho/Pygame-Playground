...
def main():
    '''Main function to run the balls animation.'''
    # Initialize Pygame
    pygame.init()
    ...
    balls = []  # List to store Ball instance
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_r:
                    # Restart by recreating balls
                    balls = [Ball(window, WINDOW_WIDTH, WINDOW_HEIGHT) for _ in range(N_BALLS)]
